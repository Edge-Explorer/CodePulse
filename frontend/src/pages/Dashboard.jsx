...
import { LayoutDashboard, History, Zap, Shield, Search, ChevronRight } from 'lucide-react';
import Sidebar from '../components/Sidebar';
import StatCard from '../components/StatCard';

/**
 * Dashboard Page Component
 * Overview of system health and repository analysis.
 */
const Dashboard = () => {
  return (
      ...
      <main style={{ flex: 1, padding: '48px', overflowY: 'auto' }}>
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '40px' }}>
            <h2 style={{ fontSize: '1.5rem', fontWeight: 600 }}>Active Repositories</h2>
          </div>
            ...
            <tbody>
              {[
                ...
                <tr key={index} style={{ borderBottom: '1px solid var(--glass-border)' }}>
                  ...
                  <td style={{ padding: '24px' }}>
                    <ChevronRight size={20} style={{ color: 'var(--text-dim)', cursor: 'pointer' }} />
                  </td>
                </tr>
              ))}
            </tbody>
